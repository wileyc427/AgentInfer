...
public sealed class PromptFileTests
{
    ...
    /// </summary>
    [Fact]
    public void A_file_outside_AdditionalFiles_is_AIN008() =>
        Assert.Contains("AIN008", Ids(Agent, [], projectDirectory: "/repo/app/"));

    [Fact]
    public void AIN008_carries_the_line_to_paste()
    {
    ...
    /// </summary>
    [Fact]
    public void A_prompt_and_a_prompt_file_together_is_AIN009() =>
        Assert.Contains("AIN009", Ids(
            """
            using System.Threading.Tasks;
            using AgentInfer;
    ...
    /// </summary>
    [Fact]
    public void A_name_matching_two_files_is_AIN010() =>
        Assert.Contains("AIN010", Ids(
            Agent,
            [
    ...
    /// neither is at the path the agent named, so this is AIN008 and not a
    /// coin toss between them.
    /// </summary>
    [Fact]
    public void A_project_directory_resolves_what_suffix_matching_cannot() =>
        Assert.Contains("AIN008", Ids(
            Agent,
            [
                ("/repo/app/v1/Prompts/thing.md", "One."),
                ("/repo/app/v2/Prompts/thing.md", "Two."),
    ...
    /// <summary>
    /// A file that exists and says nothing is the failure AIN001 is for. It
    /// arrives by a different road and gets the same answer.
    /// </summary>
    [Fact]
    public void An_empty_prompt_file_is_AIN001() =>

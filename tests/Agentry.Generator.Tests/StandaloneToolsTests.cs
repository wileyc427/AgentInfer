...
public sealed class StandaloneToolsTests
{
    ...
    public void An_invoker_is_generated_with_no_agent_present()
    {
        ...
        Assert.Contains("public sealed partial class IntakeToolsInvoker : global::Agentry.ToolInvoker", output);
    ...
    public void The_manifest_lives_on_the_invoker()
    {
        ...
        Assert.Contains("public static global::Agentry.ToolManifest Tools { get; } = new(", output);
        Assert.Contains("public override global::Agentry.ToolManifest Manifest => Tools;", output);
    }
    ...
    public void The_invoker_name_can_be_overridden()
    {
        ...
        Assert.Contains("public sealed partial class Desk : global::Agentry.ToolInvoker", output);
    }
    ...
    public void A_tools_type_with_no_tools_is_a_warning()
    {
        ...
        Assert.Contains(diagnostics, d => d.Id == "AGT012");
    }

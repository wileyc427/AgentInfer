...
public sealed class DiagnosticTests
{
    ...
    [Fact]
    public void An_empty_agent_prompt_is_AGT001() =>
    ...
    [Fact]
    public void A_method_without_a_prompt_is_AGT002() =>
        Assert.Contains("AGT002", Ids("""
    ...
    [Fact]
    public void A_non_task_return_is_AGT003() =>
        Assert.Contains("AGT003", Ids("""
            using Agentry;
            [Agent("You are terse.")]
    ...
    [Fact]
    public void Asking_for_CodeAct_is_AGT004() =>
        Assert.Contains("AGT004", Ids("""
            using System.Threading.Tasks;
            using Agentry;
            [Agent("You are terse.")]
            public interface IThing

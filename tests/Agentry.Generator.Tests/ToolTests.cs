...
public sealed class ToolTests
{
    ...
    [Fact]
    public void A_parameter_with_no_schema_is_AGT005()
    {
        ...
        Assert.Contains(diagnostics, d => d.Id == "AGT005");
    }

    [Fact]
    public void A_tool_with_no_permission_is_AGT006()
    {
        var (_, diagnostics) = GeneratorHarness.Run("""
            using System.Threading.Tasks;
            using Agentry;
        ...
        Assert.Contains(diagnostics, d => d.Id == "AGT006");
    }

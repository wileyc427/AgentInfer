...
internal static class ToolEmit
{
    ...
    public static void Manifest(StringBuilder code, string indent, IEnumerable<ToolModel> tools)
    {
        ...
        code.Append(indent).AppendLine("public static global::AgentInfer.ToolManifest Tools { get; } = new(");
        code.Append(indent).AppendLine("    new global::AgentInfer.ToolDescriptor[]");
        ...
        IEnumerable<ToolModel> tools)
    {
        ...
        code.AppendLine();
        code.Append("    public override global::AgentInfer.ToolManifest Manifest => ")

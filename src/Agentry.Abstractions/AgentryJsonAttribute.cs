...
/// another's input. A <c>JsonSerializerContext</c> emitted by Agentry would be
...
/// declare six lines of context, STJ's generator fills it in, and Agentry's
...
public sealed class AgentryJsonAttribute : Attribute
{
    public AgentryJsonAttribute(Type context) => Context = context;
